...
*/ const searchIcon = document.querySelector("#searchIcon"), searchInput = document.querySelector("#searchInput"), coctailName = document.querySelector("[data-coctail-name]"), coctailDescription = document.querySelector("[data-coctail-description]");
